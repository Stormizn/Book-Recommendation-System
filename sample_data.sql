-- Sample Books Data
-- ==================
-- Run this ONCE after database.sql to fill the books table with sample data.
-- Re-running it will INSERT DUPLICATE copies of these books, so do not run
-- it again on a database that already has this data. Users, ratings, and
-- reading lists are never touched by this file.
